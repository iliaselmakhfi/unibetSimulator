...
public final class Helpers {
	...
	/**
	 * Selon le nombre alétoire 0, 1 ou 2, nous allons : 0 : Garder la cote comme
	 * telle 1 : Augmenter la cote de 0.1 2 : Diminuer la cote de 0.1 (si possible)
	 */
	public static BigDecimal updateOddRandomly(BigDecimal originalOdd) {
		...
		default:
			...
			return originalOdd.subtract(new BigDecimal("0.1")).compareTo(BigDecimal.ONE) < 0 ? BigDecimal.ONE
					: originalOdd.subtract(new BigDecimal("0.1"));
		}
	}
